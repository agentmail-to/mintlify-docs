---
title: LangChain
description: Give a LangChain or LangGraph agent its own inbox to send, search, and reply to email.
...
<Frame caption="One toolkit call gives the agent all fourteen email tools.">

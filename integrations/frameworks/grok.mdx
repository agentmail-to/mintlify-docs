---
title: Grok
description: Connect AgentMail to the Grok app or Grok Build so it can send, receive, and reply to email from its own inbox.
...
<CardGroup cols={2}>
  <Card title="Use a custom domain" icon="globe" href="/advanced/custom-domains">
    Give your agent an address on your own domain instead of `@agentmail.to`.
  </Card>

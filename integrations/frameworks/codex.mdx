---
title: OpenAI Codex
description: Install the AgentMail plugin and give Codex its own inbox to send, receive, and reply to email.
...
<Frame caption="A headless codex exec run reaches AgentMail through the local bridge and lists the account's inboxes.">
...
<CardGroup cols={2}>
  <Card title="MCP and Skills" icon="plug" href="/integrations/mcp-and-skills">
    Every hosted tool, with setup for the other clients that connect to them.
  </Card>

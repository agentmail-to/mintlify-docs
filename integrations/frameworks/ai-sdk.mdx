---
title: Vercel AI SDK
description: Give a Vercel AI SDK agent its own inbox to send, receive, and reply to email.
...
<Frame caption="A send run traced with a small onStepFinish log in agent.ts; this run reused an existing inbox, so list_inboxes stands in for create_inbox.">

...
<Frame caption="A loaded plugin reports both surfaces: the email channel and the agentmail CLI command.">
...
<Frame caption="The passthrough command listing inboxes and sending the first email.">

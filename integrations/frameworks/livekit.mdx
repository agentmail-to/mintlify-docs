...
description: Give a LiveKit voice agent its own inbox to send, reply to, and announce email mid-call.
...
<Frame caption="The same session driven with the console's --text flag, where the agent narrates the send_message call while it runs and then confirms the send.">

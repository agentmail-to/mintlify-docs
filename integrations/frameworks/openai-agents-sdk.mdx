...
description: Give an OpenAI Agents SDK agent its own inbox to send, receive, and reply to email.
...
<Frame caption="A real run of send.py, ending with the agent's report of the sending address.">

...
<Frame caption="Hermes resolves the inbox, calls send_message, and reports the thread id.">
...
<Frame caption="A two-subagent fanout running in parallel, each with the inherited AgentMail toolset.">
